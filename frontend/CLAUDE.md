...
- `src/components/` — feature components (`AddBlockSheet`, `BlockRow`, `RepertoireBlockRow`, `SectionCard`, `SessionTabs`, `RepertoireBlock`, `RatingChevrons`, `TimeStepper`, `ConfirmDialog`)
